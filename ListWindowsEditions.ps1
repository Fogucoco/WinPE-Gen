...
Write-Host "Please extract the install.esd or install.wim file from a Windows installation ISO,\nthe script can't read directly from the ISO or ISO mounted drive.\n"
